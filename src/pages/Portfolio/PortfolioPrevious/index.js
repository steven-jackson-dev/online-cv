...
import AppModalImage from 'components/AppModalImage';
import { PortfolioPreviousData } from 'api/portfolioPreviousData'
            ...
            <PopIn>
                <Container>
                    ...
                    <Row>
                        ...
                        <AppModalImage show={modalShow} content={modalContent} onHide={() => setModalShow(false)} />
                    </Row>
                </Container>
            </PopIn>
        </section>
